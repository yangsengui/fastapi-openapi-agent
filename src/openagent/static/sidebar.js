(function() {
	...
	//#endregion
	//#region src/loader/request-bridge.ts
  ...
  `;
	...
	function setupToggleShortcut(isOpen, setOpen) {
		document.addEventListener("keydown", (event) => {
			...
			if (target && [
				...
				"TEXTAREA",
				"SELECT"
			].includes(target.tagName) || event.defaultPrevented) return;
	...
	function mountEmbedded(target, config, src, baseUrl) {
	...
	function mountFloating(config, src, baseUrl) {
